...
class TestTrackerResponseScanner(unittest.TestCase):
    def test_scanTrackerResponse_ValidContentBinaryModel_CorrectNonPeerContent(self) -> None:
    ...
    def test_scanTrackerResponse_ValidContentBinaryModel_CorrectPeerList(self) -> None:
